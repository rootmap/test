...
@section("title","Edit Simple Cash Register")
@section("content")
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Simple Cash Register</h1>
      </div>
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('simplecashregister/list')}}">Datatable </a></li>
              <li class="breadcrumb-item"><a href="{{url('simplecashregister/create')}}">Create New </a></li>
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Edit / Modify Simple Cash Register</h3>
            <div class="card-tools">
              <ul class="pagination pagination-sm float-right">
                <li class="page-item">
                    <a class="page-link bg-primary" href="{{url('simplecashregister/create')}}"> 
                        Create 
                        <i class="fas fa-plus"></i>
                    </a>
                </li>
                <li class="page-item">
                    <a class="page-link bg-primary" href="{{url('simplecashregister/list')}}"> 
                        Data 
                        <i class="fas fa-table"></i>
                    </a>
                </li>
                <li class="page-item">
                  <a class="page-link  bg-primary" target="_blank" href="{{url('simplecashregister/export/pdf')}}">
                    <i class="fas fa-file-pdf" data-toggle="tooltip" data-html="true"title="Pdf"></i>
                  </a>
                </li>
                <li class="page-item">
                  <a class="page-link  bg-primary" target="_blank" href="{{url('simplecashregister/export/excel')}}">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('simplecashregister/update/'.$dataRow->id)}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
                            ...
                            <div class="col-md-6">
                                @if(isset($dataRow->content_image))
                                    @if(!empty($dataRow->content_image))
                                        <img class="img-thumbnail" src="{{url('upload/simplecashregister/'.$dataRow->content_image)}}" width="150">
                                    @endif
                                @endif
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('simplecashregister/edit/'.$dataRow->id)}}">
