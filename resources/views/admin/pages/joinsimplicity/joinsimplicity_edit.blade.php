...
@section("title","Edit Join Simplicity")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Update Join Simplicity</li>
            </ol>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Edit / Modify Join Simplicity</h3>
        </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('joinsimplicity/update/'.$dataRow->id)}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
                            ...
                            <div class="col-md-6">
                                @if(isset($dataRow->content_image))
                                    @if(!empty($dataRow->content_image))
                                        <img class="img-thumbnail" src="{{url('upload/joinsimplicity/'.$dataRow->content_image)}}" width="150">
                                    @endif
                                @endif
                            </div>
                        </div>
        <div class="row">
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('joinsimplicity/edit/'.$dataRow->id)}}">
