...
@section("title","Edit Core Software Components")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('coresoftwarecomponents/list')}}">Datatable </a></li>
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Edit / Modify Core Software Components</h3>
            <div class="card-tools">
              <ul class="pagination pagination-sm float-right">
                ...
                <li class="page-item">
                    <a class="page-link bg-primary" href="{{url('coresoftwarecomponents/list')}}"> 
                        Data 
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('coresoftwarecomponents/update/'.$dataRow->id)}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
                            ...
                            <div class="col-md-6">
                                @if(isset($dataRow->content_image))
                                    @if(!empty($dataRow->content_image))
                                        <img class="img-thumbnail" src="{{url('upload/coresoftwarecomponents/'.$dataRow->content_image)}}" width="150">
                                    @endif
                                @endif
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('coresoftwarecomponents/edit/'.$dataRow->id)}}">
