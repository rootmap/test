            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="{{url('videos/create')}}">Create New </a></li>
                  ...
                  <h3 class="card-title">Videos Data</h3>
                    ...
                    <div class="card-tools">
                      <ul class="pagination pagination-sm float-right">
                        <li class="page-item">
                            <a class="page-link bg-primary" href="{{url('videos/create')}}"> 
                                Add New 
                                <i class="fas fa-plus"></i> 
                            </a>
                        </li>
                        <li class="page-item">
                          <a class="page-link" target="_blank" href="{{url('videos/export/pdf')}}">
                            <i class="fas fa-file-pdf" data-toggle="tooltip" data-html="true"title="Pdf"></i>
                          </a>
                        </li>
                        <li class="page-item">
                          <a class="page-link" target="_blank" href="{{url('videos/export/excel')}}">
                        ...
                        @if(count($dataRow))
                            @foreach($dataRow as $row)  
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{url('videos/edit/'.$row->id)}}" type="button" class="btn btn-default">
                                                Edit 
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="{{url('videos/delete/'.$row->id)}}" type="button" class="btn btn-default">
                                                Delete 
