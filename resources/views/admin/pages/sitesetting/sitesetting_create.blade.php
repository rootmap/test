                ...
                <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Instagram Link" id="instagram_link" name="instagram_link">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Facebook Link" id="facebook_link" name="facebook_link">
                      </div>
                    </div>
