    ...
    <div class="header-left">
        ...
        <div class="navbar-header">
            ...
            <a id="tour-1" style="padding-bottom: 5px;" class="navbar-brand bg-info border-bottom-info" href="{{url('dashboard')}}">
                <img class="logo" height="45" src="{{asset('admin/images/logo/logo-white.png')}}" alt="brand logo"/>
            ...
            <ul class="nav navbar-nav float-xs-right">
                ...
                <li class="dropdown dropdown-user nav-item border-right-grey border-lighten-2">
                    ...
                    <span class="avatar avatar-online">
                        <img src="{{url('admin/theme/app-assets/images/portrait/small/avatar-s-1.png')}}" alt="avatar">
                        <i></i>
                    </span>
                    <span class="user-name">asdasd</span>
                    </a>
              </li>
{{-- 
