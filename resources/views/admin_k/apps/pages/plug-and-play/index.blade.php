			...
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-card-center">
						@if(isset($edit))
						<i class="icon-user-plus"></i> Edit Plug And Play
						@else
						<i class="icon-user-plus"></i> Add Plug And Play
						@endif
					</h4>
				...
				<div class="card-body collapse in">
					<div class="card-block">
						...
						@if(isset($edit))
							action="{{url('admin-site/plug-and-play/modify/'.$edit->id)}}"
						@else
							action="{{url('admin-site/plug-and-play/save')}}"
						@endif
						>
							<div class="form-body">
								{{ csrf_field() }}
