        ...
        <div class="container">
          <div class="row justify-content-md-center align-items-md-center row-55">
            <div class="col-md-6 wow fadeInLeft text-left" data-wow-duration="1s" data-wow-delay="0.10s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInLeft;">
              <h2>Business POS System</h2>
              <p class="text-gray">Technology has played a huge role in revolutionizing the way businesses are operated all over the planet. If you still utilize an outdated cash register and have system to formulate critical reports regarding your business, then you’re clearly not in touch with technology and are losing out on ROI. Need to keep a strong technical eye over your operations? Switch to our state-of-the-art small business POS system today! Our one-of-a-kind point of sales system is comprised of a combination of several software and hardware components that work together to assist in quality business management operations.</p>
            </div>
            <div class="col-md-6 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.10s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInRight;">
              <figure class="figure-fullwidth"> <img src="{{url('upload/retail_image/business-pos-system.png')}}" alt="simpleretailpos" width="620" height="465">
              </figure>
            </div>
          </div>
        </div>
      ...
      <section class="section wow fadeInUp" id="features" data-type="anchor" data-wow-duration="1s" data-wow-delay="0s" style="visibility: visible; animation-duration: 1s; animation-delay: 0s; animation-name: fadeInUp;">
        <div class="container w-container w-features">
          <div class="top-wrapper-margin">
            ...
            <h2 class="top-title-2">Our Core Software Components</h2>
            <p class="text-gray">Some of our notable software components which act as a backbone in running any business include</p>
            <br>
          </div>
          <div>
            <div class="row">
              <div class="col-md-6 col-lg-6 col-xl-6 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.10s" style="border-right: 1px solid #ccc;border-bottom: 1px solid #ccc;padding:35px; visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInDown;">
                <div class="services-wrapper">
                  <div>
                    <img src="{{url('site/images/paypal-logo.png')}}" alt="simpleretailpos" class="features-icon" width="85">
                    <div>
                      <h4 class="features-title">PAYPAL Integration
                        <br>
                      </h4>
                      <p class="text-gray">It is definitely the most basic yet extremely critical software feature of the Simple Retail POS. It is capable of processing cash, credit cards and a whole plethora of other payment options including PayPal which your customers might prefer.</p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-6 col-xl-6 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.10s" style="border-bottom: 1px solid #ccc;padding:35px; visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInDown;">
                <div class="services-wrapper">
                  <div>
                    <img src="{{url('upload/feature/1563476491.png')}}" alt="simpleretailpos" class="features-icon" width="85">
                    <div>
                      <h4 class="features-title">POWERFUL INVENTORY MANAGEMENT SIMPLIFIED
                        <br>
                      </h4>
                      <p class="text-gray">This is another essential characteristic of a business management system. Its significance even increases if you are in the business of retailing. Gone are the days when you had to manually keep the record of all the products which you have in inventory. It was not only a tedious task, but was extremely time consuming too. Our first-rate POS system automatically tracks the entry and sale of items from your inventory</p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-6 col-xl-6 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.10s" style="border-right: 1px solid #ccc;padding:35px; visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInDown;">
                <div class="services-wrapper">
                  <div>
                    <img src="{{url('upload/feature/1563476478.png')}}" alt="simpleretailpos" class="features-icon" width="85">
                    <div>
                      <h4 class="features-title">
                        CUSTOMER CMS WITH CUSTOMER LEADS
                        <br>
                      </h4>
                      <p class="text-gray">It is an absolutely exciting software feature of Simple POS System for Small Business. Our system completely eliminates the need of purchasing a separate tool which can take care of customer’s related matters since we, at Simple Retail POS, have integrated this feature into our POS system.</p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-6 col-xl-6 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.10s" style="padding:35px; visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInDown;">
                <div class="services-wrapper">
                  <div>
                    <img src="{{url('upload/feature/1563476464.png')}}" alt="simpleretailpos" class="features-icon" width="85">
                    <div>
                      <h4 class="features-title">TURORIAL VIDEOS
                        <br>
                      </h4>
                      <p class="text-gray">Our system offers comprehensive videos to help our clients easily learn all the relative features for their business and get the most out of them!</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section class="section bg-gray-light wow fadeInUp" id="features" data-type="anchor" data-wow-duration="1s" data-wow-delay="0s" style="visibility: visible; animation-duration: 1s; animation-delay: 0s; animation-name: fadeInUp;">
        <div class="container w-container w-features">
          <div class="top-wrapper-margin">
            ...
            <h2 class="top-title-2">Core Hardware Components Needed by Simple Retail POS</h2>
            <p class="text-gray">Think you need a detailed range of hardware devices to run our state-of-the-art Simple POS system? Think again! Our experts have designed our unique POS system to run even with some of the most basic hardware components with fluidity. Here’s what you need to run Simple POS</p>
            <br>
          </div>
          <div>
            <div class="row">
              <div class="col-md-6 col-lg-3 col-xl-3 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.10s" style="padding:35px; visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInDown;">
                <div class="services-wrapper">
                  <div>
                    <img src="{{url('site/images/tablet.png')}}" alt="simpleretailpos" class="features-icon" width="150">
                    <div>
                      <h4 class="features-title">Register Screen
                        <br>
                      </h4>
                      <p class="text-gray">To use our unique POS system you will need a very simple register screen to act as the display unit. You can make use of the display of your tablet, smartphone, or even your personal computer as a register screen. </p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-3 col-xl-3 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.10s" style="padding:35px; visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInDown;">
                <div class="services-wrapper">
                  <div>
                    <img src="{{url('site/images/printer.png')}}" alt="simpleretailpos" class="features-icon" width="150">
                    <div>
                      <h4 class="features-title">Printer<br>
                      </h4>
                      <p class="text-gray">Simple Retail POS allows you to connect three different printers with the POS system at the same time which should be more than enough for most of businesses in the retail industry. These printers can further be used to print multiple receipts at the same time. </p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-3 col-xl-3 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.10s" style="padding:35px; visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInDown;">
                <div class="services-wrapper">
                  <div>
                    <img src="{{url('site/images/barcode-scanner.png')}}" alt="simpleretailpos" class="features-icon" width="150">
                    <div>
                      <h4 class="features-title">Barcode Scanner<br>
                      </h4>
                      <p class="text-gray">If you are considering to Buy POS System for your enterprise then a barcode scanner is probably the most crucial piece of equipment that you need. A very lightweight device that is simple to use, and helps all</p></div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-lg-3 col-xl-3 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.10s" style="padding:35px; visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInDown;">
                  <div class="services-wrapper">
                    <div>
                      <img src="{{url('site/images/cash-register.png')}}" alt="simpleretailpos" class="features-icon" width="150">
                      <div>
                        <h4 class="features-title">Cash Register<br>
                        </h4>
                        <p class="text-gray">Even though it is true that physical cash is running out of fashion at a very fast paced and probably it will completely vanish in coming few years, it is still preferred by a considerable number of people. Therefore, it would be better to keep one at your store so that you can accommodate every single customer of yours. </p>
                      </div>
                    </div>
                  </div>
                </div>
